...
(function(){
  ...
  const client_id = "Iv1.7ee6bf8ca2536e4e";
  const client_secret = "77727d3ab13ce13c0eef2beb76bc26285f146d41";
  const  count = 7;
  const sort = "created: asc";
  async function getUser(user){
     // buscar no github as informaçoes do usarios //
   ...
   function showProfile(user){
    ...
    <div class="col-md-4">
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">Repositorios:  <span class="badge" badge-success">${
          user.public_repos
        }</span></li>
  ...
  // pegar o valor vindo de search e colocando o evento de esccuta pegando o valor e colocando em user//
  search.addEventListener("keyup", e =>{
     const user = e.target.value;

     if(user.length > 0){
      // enviar o valor do input para o getuser//
